  ...
  <div class="grid">
    <div class="col-12">
      <div class="card">
          ...
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              ...
              <div class="flex flex-row">
                <Button label="Add User" icon="pi pi-plus" class="mr-2" severity="success" @click="openNew" />
        ...
        <Dialog v-model:visible="userDialog" :style="{ width: '80rem' }" header="User Information" :modal="true"
          ...
          <div class="p-fluid formgrid grid">
            ...
            <div class="field col-12 md:col-4">
              ...
              <IconField>
                <InputIcon class="pi pi-user"
                  :class="formSubmitted && !userStore.thisUser.last_name ? 'text-red-300' : ''" />
            ...
            <div class="field col-6">
              ...
              <IconField>
                <InputIcon class="pi pi-phone"
                  :class="formSubmitted && !userStore.thisUser.contact_number ? 'text-red-300' : ''" />
            ...
            <div class="field col-6">
              ...
              <IconField>
                <InputIcon class="pi pi-envelope"
                  :class="formSubmitted && !userStore.thisUser.email ? 'text-red-300' : ''" />
